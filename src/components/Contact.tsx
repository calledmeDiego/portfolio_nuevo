            ...
            <form method="POST" className="xl:pl-10 2xl:pl-20" action={`https://getform.io/f/avrywxma`}>
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                    <div className="mb-4">
                        ...
                        <input type="text" name="name" id="name" autoComplete="name" required placeholder="Henry Clark" className="text-field reveal-up" />
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        <input type="email" name="email" id="email" autoComplete="email" required placeholder="henry@example.com" className="text-field reveal-up" />
                    </div>
