        ...
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                <h2 className="headline-2 lg:max-w-[12ch] reveal-up">
                    Contactame para colaborar
                </h2>
                <p className="font-text text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch]">
                    ¡Contactame hoy mismo para hablar sobre las necesidades de tu proyecto y empezar a colaborar en algo increíble!
                </p>
            ...
            <form method="POST" className="xl:pl-10 2xl:pl-20" action={`https://getform.io/f/avrywxma`}>
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                    <div className="mb-4">
                        <label htmlFor="name" className="label reveal-up">
                            Nombre
                        </label>
                        <input type="text" name="name" id="name" autoComplete="name" required placeholder="Ingresa tu nombre aquí" className="text-field reveal-up" />
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        <input type="email" name="email" id="email" autoComplete="email" required placeholder="diego@example.com" className="text-field reveal-up" />
                    </div>
                ...
                <div className="mb-4">
                    ...
                    <textarea name="message" id="message" placeholder="¡Hola!" required className="text-field resize-y min-h-32 max-h-80 reveal-up"></textarea>
                </div>
                <button type="submit" className="btn-submit btn-primary-submit 
                ">Enviar</button>
            </form>
        </div>
    </section>
